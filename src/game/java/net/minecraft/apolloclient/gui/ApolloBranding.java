...
public class ApolloBranding {

    private static final ResourceLocation APOLLO_LOGO = new ResourceLocation("apolloclient/title/logo.png");

    public static void render(int screenWidth, int screenHeight) {
        Minecraft mc = Minecraft.getMinecraft();
        FontRenderer fr = mc.fontRendererObj;

        String title = "Apollo Client";
        ...
        mc.getTextureManager().bindTexture(APOLLO_LOGO);
